    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: 'var(--panda-bg)' }}>
        <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-md text-center">
          ...
          <h2 className="text-xl font-bold text-gray-800 mb-2">Bestätigungs-E-Mail gesendet!</h2>
    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: 'var(--panda-bg)' }}>
      <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-md">
        ...
        >
          ...
          <span className="text-gray-700 font-medium">Mit Google registrieren</span>
        </button>
